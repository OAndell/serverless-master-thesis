...
% ylim([-1 ylimit])
%P95
[p95_time_mono,p95_mono, median] = get_json('wl0mono2.json');
ax4 = nexttile;
...
xlabel(ax4,'Time (s)')
xline(60, '--',{'Hold','phase'},'HandleVisibility','off')
...
% xlim([-1 xlimit])
% ylim([-1 ylimit])
[p95_time_serv,p95_serv, median] = get_json('wl0serv2.json');
ax5 = nexttile;
plot(ax5, p95_time_serv/1000, p95_serv,'black','Marker','diamond')
title(ax5,'Serverless')
hold on
...
[p95_time_serv,p95_serv, median] = get_json('wl0ms2.json');
ax6 = nexttile;
h1 = plot(ax6, p95_time_serv/1000, p95_serv,'black','Marker','diamond');
title(ax6,'µServerless')
hold on

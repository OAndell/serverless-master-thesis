...
var csvStream = csv.createWriteStream({ headers: true }), writableStream = fs.createWriteStream(`result-${Date.now()}.csv`);
...
function onLoadingStarted(requestParams, context, ee, next) {
  //requestParams.url = "https://monolith-oscan898.azurewebsites.net/services"
